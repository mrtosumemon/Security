...
gd_buttons = [              
        [
            InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇ", url="https://t.me/Boy_Girl_Dp"),
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/Freinds_club"),    
        ]
        ]
# ------------------------------------------------------------------------------- #
...
async def start(_, msg):
    REPO_BTN = [
        [
          InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/Freinds_Club"),
          InlineKeyboardButton("ʀᴇᴘᴏ", url="https://t.me/boy_Girl_Dp"),
          ],
    ]
...
async def activevc(_, message: Message):
    ...
    reply_text = (
        ...
        f"✦ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ➠  ɢ ʀ ᴇ ᴀ ᴛ - ᴘ ᴇ ʀ ꜱ ᴏ ɴ ࿐"
    )
